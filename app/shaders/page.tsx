  ...
  return (
    <div className="flex min-h-screen flex-col justify-between">
      ...
      <div className="flex w-full mt-96 px-48 text-xl">
        <div className="flex border py-16 px-8 bg-white items-center border-black rounded-xl">
          <div className="w-2/3 pr-32 -mt-16">
            ...
            <p className="mt-6 leading-9">
              ...
              shaders, and they can be as complex or as simple as the artists
              and programmers want them to be.
            </p>
            <p className="mt-6 leading-9">
              As an{' '}
              <a
      ...
      <div className="flex w-full mt-96 px-48">
        <div className="w-full px-8 py-8 rounded-xl border border-black bg-white">
      ...
      <div className="flex w-full mt-96 px-48 text-xl">
        <div className="flex border border-black px-8 py-24 rounded-xl bg-white items-center">
          ...
          <div className="-mt-8 w-2/3 pl-32">
            ...
            <p className="mt-6 leading-9">
              ...
              final colour of each individual pixel on the screen, depending on
            ...
            <p className="mt-6 leading-9">
              ...
              can be used to create complicated graphics effects and scenes,
      ...
      <div className="flex w-full mt-96 px-48">
        <div className="w-full px-8 py-16 rounded-xl border border-black bg-white">
