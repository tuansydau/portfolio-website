...
const buttonClass =
  'border-black border py-2 px-4 text-lg bg-white hover:bg-black hover:text-white border-b-3 border-r-2';

const highlightedClass =
  'border-black border py-2 px-4 text-lg bg-black text-white border-b-2';
...
export default function Navbar({
  ...
  return (
    <div
      className="z-10 flex w-full justify-center py-3 items-center space-x-12 border-black bg-white"
      // style={{ backgroundColor: 'rgba(255, 255, 255, 0)' }}
    >
      <div className="flex justify-between w-full max-w-[1360px]">
        <Link href="/">
          <Image
            src="/tuan-dau.gif"
